...
const block_chains_payload_count = all_block_payloads.reduce(
  ...
  >
    <div class="stats shadow py-[3.5rem]">
      ...
      <div class="stat">
        ...
        <div class="stat-title">Chains Payload</div>
        <div class="stat-value text-secondary">
          {{ block_chains_payload_count }}
        </div>
        <div class="stat-desc">
          All of the transactions sum in the blockchain
        </div>
      </div>
    </div>
  </div>
